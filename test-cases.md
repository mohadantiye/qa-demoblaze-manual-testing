...
valid links: i will try to click every link and i expect all of them to be working
Adding products to cart: i will try to add products to carts and will be expecting them to be added successfullly 
Remove from cart: i will try to remove an item from cart and will be expecting the item ro b removed successfully 
and finally checkout i will place an order with valid details and expect it to beplaced successfully 
